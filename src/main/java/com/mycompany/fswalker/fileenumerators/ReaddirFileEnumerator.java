...
public class ReaddirFileEnumerator extends FileEnumerator {
    @Override
    public boolean enumerateEntries(
        ...
        ArrayList<LowLevelStructures.LinuxDirent64> entries = LowLevelUtils.READDIR.ReadDirEntries(dirPath);
